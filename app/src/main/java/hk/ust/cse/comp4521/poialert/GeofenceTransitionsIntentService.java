...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    private void sendNotification(String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), POIAlertActivity.class);

        // Construct a task stack.
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);

        // Add the main Activity to the task stack as the parent.
        stackBuilder.addParentStack(POIAlertActivity.class);
        ...
        builder.setSmallIcon(R.drawable.ic_menu_notifications)
                ...
                .setSound(Uri.parse("android.resource://hk.ust.cse.comp4521.poialert/" + R.raw.proximity_alert))
